  ...
  return (
    <div style={{ maxWidth: 1000, margin: '40px auto', padding: 20 }}>
      ...
      <div style={{ background: '#f0f2f5', padding: 20, borderRadius: 20, marginBottom: 30 }}>
        ...
        <input type="date" value={newEvent.date} onChange={e => setNewEvent({...newEvent, date: e.target.value})} style={{ margin: 5, padding: 8, borderRadius: 12, border: '1px solid #ccc' }} />
        ...
        <input type="text" value={newEvent.venue} onChange={e => setNewEvent({...newEvent, venue: e.target.value})} placeholder="Locale" style={{ margin: 5, padding: 8, borderRadius: 12, border: '1px solid #ccc' }} />
